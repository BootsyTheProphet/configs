...
#custom#########################################################
#To Do:
# promt for address of pod
# 2.check for shared folder if it doesnt exitst make it
# 3. podman pull <address>

# kali tty podman container with GUI ability
alias create_kali="podman container create --name=kali -it -e DISPLAY=$DISPLAY --network host -v /tmp/.X11-unix:/tmp/.X11-unix -v ~/Desktop/kali_shared:/home/kali_shared kalilinux/kali-rolling"
